  ...
  <nav class="navbar navbar-custom" role="navigation">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <div class="site-logo">
            <a href="index.html" class="brand"><img style="width:25%; height: 25%; margin-top: -7%;"
                src="<?php echo base_url('assets/frontend/img/logoclp.png') ?>"></img>
              <clp style="font-size: 50%; margin-left: 2%;">Club lobi pilm</clp>
            </a>
          </div>
        </div>
