...
<div class="sidebar-menu">
  <div class="sidebar-header">
    <div class="logo">
      <a href="index.html"><img src="<?php echo base_url('lib/backend/images/icon/logo.png') ?>" alt="logo"></a>
    </div>
  </div>
  <div class="main-menu">
    <div class="menu-inner">
      <nav>
        <ul class="metismenu" id="menu">
          ...
          <li>
            <a href="<?php echo base_url('admin/home/artikelStatis') ?>" aria-expanded="true"><i
                class="ti-layout-sidebar-left"></i><span>Artikel Statis</span></a>
          </li>
          <li>
          ...
          <li>
            <a href="<?php echo base_url('admin/home/keanggotaan') ?>"><i class="ti-id-badge"></i><span>Keanggotaan</span></a>
          </li>
          <li><a href="<?php echo base_url('admin/home/karya') ?>"><i class="ti-image"></i><span>Karya Anggota</span></a></li>
          <li><a href="<?php echo base_url('admin/home/genre') ?>"><i class="ti-menu-alt"></i><span>Genre</span></a></li>
          <li>
