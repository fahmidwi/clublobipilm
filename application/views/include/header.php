          ...
          <div class="col-md-9">
            ...
            <div class="collapse navbar-collapse" id="menu">
              <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="<?php echo base_url('home/index') ?>">Beranda</a></li>
                <li><a href="<?php echo base_url('home/tentangKami') ?>">Tentang Kami</a></li>
                <li><a href="<?php echo base_url('home/index/#service') ?>">Program Kerja</a></li>
                <li><a href="<?php echo base_url('home/karya') ?>">Hasil Karya</a></li>
                <li><a href="<?php echo base_url('home/keanggotaan') ?>">Keanggotaan</a></li>
                <li><a href="<?php echo base_url('home/index/#contact') ?>">Hubungi Kami</a></li>
              </ul>
            </div>
            <!-- /.Navbar-collapse -->
