      ...
      <div class="main-content-inner">
        <div class="row">
          ...
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                <h4 class="header-title">Form Edit Artikel</h4>
                <hr>
                <form method="POST"
                  action="<?php echo base_url('admin/ArtikelStatis/ProsesUbahData/'.$artikelstatis->id_artikel_statis) ?>">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="title" type="text" id="example-text-input"
                          value="<?php echo $artikelstatis->title; ?>" disabled>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
