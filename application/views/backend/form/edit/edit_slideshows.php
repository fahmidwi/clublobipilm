            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Form Edit Slideshow</h4><hr>
                                <form method="POST" action="<?php echo base_url('admin/SlideShows/ProsesUbahData/'.$slideshow->id_slide) ?>" enctype="multipart/form-data">
																	<div class="row">
																			<div class="col-md-6">
																			<div class="form-group">
																					<label for="example-text-input" class="col-form-label">Judul</label>
																					<input class="form-control" name="judul" type="text" id="example-text-input" placeholder="Judul" value="<?php echo $slideshow->title; ?>">
																			</div>
																			<div class="form-group">
																					<label for="example-text-input" class="col-form-label">Deskripsi</label>
																					<textarea name="deskripsi_slide">
                                            <?php echo $slideshow->desk ?>
																					</textarea>
																			</div>
																	</div>
																	<div class="col-md-6">
																			<label class="col-form-label">Gambar lama</label><br><br>
                                      <img src="<?php echo base_url('assets/frontend/img/slideshow/'.$slideshow->file) ?>" width="200px" height="100px" /><br><br>
																			<label for="example-text-input" class="col-form-label">Pilih Gambar Baru</label>
																			<div class="custom-file">
																					<input type="file" name="file" class="custom-file-input" id="inputGroupFile01">
																					<label class="custom-file-label" for="inputGroupFile01">Choose file</label>
																			</div>
																			<p style="color:blue;">Gambar akan di ubah menjadi ukuran 1920px x 600px, sesuaikan ukuran dan resolusi gambar<p>
																	</div>
