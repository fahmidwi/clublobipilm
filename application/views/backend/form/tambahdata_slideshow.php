            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Form Tambah Slideshow</h4><hr>
                                <form method="POST" action="<?php echo base_url('admin/SlideShows/prosesTambahData') ?>" enctype="multipart/form-data">
																	<div class="row">
																			<div class="col-md-6">
