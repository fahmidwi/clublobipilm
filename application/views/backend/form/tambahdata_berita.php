          ...
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
                <form method="POST" action="<?php echo base_url('admin/Berita/prosesTambahData') ?>"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="judul_berita" id="example-text-input"
                          placeholder="Judul Berita" pattern="[a-zA-Z0-9\s]+" required>
                        <i>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="sumber" id="example-text-input"
                          placholder="ex:https://berita.com" required>
                      </div>
                    </div>
