					...
					<div class="main-content-inner">
							<div class="row">
									...
									<div class="col-12 mt-5">
											<div class="card">
													<div class="card-body">
															<h4 class="header-title">Data Artikel Statis</h4>
																	...
																	<table id="dataTable3" class="text-center">
																			...
																			<?php $no=1; foreach($artikelstatis as $res) { ?>
																				<tr>
																					...
																					<td>
																						<a href="<?php echo base_url('admin/ArtikelStatis/ubahData/'.$res->id_artikel_statis) ?>" class="badge badge-primary">Edit</a>
																					</td>
																				</tr>
																			<?php $no++;} ?>
																			</tbody>
