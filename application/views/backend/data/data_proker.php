          ...
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                ...
                <a href="#" class="badge badge-primary" data-toggle="modal" data-target=".tambahproker">Tambah
                  Data</a><br><br>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="badge badge-warning" data-toggle="modal"
                            data-target=".proker<?php echo $res->id_proker ?>">Detail</a>
                          <a href="<?php echo base_url('admin/Proker/ubahData/' . $res->id_proker) ?>"
                            class="badge badge-primary">Edit</a>
                          <a href="<?php echo base_url('admin/Proker/delete/' . $res->id_proker) ?>"
                            onClick="return confirm('Menghapus data secara permanen, hapus?')"
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input name="judul" class="form-control" type="text" id="example-text-input"
                                placholder="masukan judul program kerja" pattern="[a-zA-Z0-9\s]+" required>
                              <i>
                                <p style="color:red;">judul tidak boleh mengandung karakter spesial</p>
                              </i>
                            </div>
                            <div class="form-group">
