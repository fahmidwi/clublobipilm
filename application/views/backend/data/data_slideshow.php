          ...
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                ...
                <a href="<?php echo base_url('admin/SlideShows/tambahData') ?>" class="badge badge-info">Tambah
                  Data</a><br>
                ` <div class="data-tables datatable-dark">
                  <table id="dataTable3" class="text-center">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><img src="<?php echo base_url('assets/frontend/img/slideshow/'.$res->file); ?>"
                            height="150px" width="300px" /></td>
                        <td><?php echo $res->title; ?></td>
                        <td><?php echo $res->desk; ?></td>
                        <td>
                          <a href="<?php echo base_url('admin/SlideShows/ubahData/'.$res->id_slide) ?>"
                            class="badge badge-primary">Edit</a>
                          <a href="<?php echo base_url('admin/SlideShows/delete/'.$res->id_slide) ?>"
