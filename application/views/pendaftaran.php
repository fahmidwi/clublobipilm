  ...
  <section id="about" class="home-section color-dark bg-white" style="margin-top: -10%;">
    <div class="container marginbot-50">
      ...
      <!-- <div class="row wow fadeIn">
        <div class="col-lg-6 " >
          <div data-wow-offset="0" data-wow-delay="0.4s" id="pendaftaran">
          ...
          <form method="post" action="<?php echo base_url('home/prosesPedaftaran'); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group ui-widget">
              ...
              <input type="text" name="asal_sekolah" id="asalSekolah" class="form-control"
                placeholder="Masukan Asal Sekolah" style="text-transform:uppercase" required>
              <div id="autokomplit"
        ...
        <div class="col-lg-6 " id="sudahterdaftar">
...
$(document).ready(function() {
  ...
  $('#durasi').on('change', function() {
    ...
    if (durasi > 15) {
      $('#alert-durasi').show();
      $('#daftar').prop('disabled', true);
      $('#ceksk').attr('disabled', true)
    } else {
      $('#ceksk').attr('disabled', false)
      $('#alert-durasi').hide();
      $('#ceksk').removeAttr('checked');
    }
  });
