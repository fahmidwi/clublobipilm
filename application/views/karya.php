        ...
        <div class="col-lg-12">
          <div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
            <div class="section-heading">
              <h3 style="font-family: lato; font-weight:bold;"><blockquote>KARYA DARI ANGGOTA CLP</blockquote></h3>
            </div>
          </div>
          <form>
          <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="tahun">
                        ...
                        for ($i=2010; $i < 2030; $i++) { ?>
                          <option value=<?php echo $i; ?> <?php echo ($i==$tahun ? 'selected' :null) ?> ><?php echo $i; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
