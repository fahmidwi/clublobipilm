...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom" style="margin: 0px;">
  <!-- Section: about -->
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <center>
            ...
            <img src="<?php echo base_url('assets/frontend/img/terimakasih.png') ?>" width="35%" height="20%">
            <p style="margin-top: 5%; font-size: 15pt;">Terima kasih sudah mendaftar pada acara INDIEFEST ini,
              kami akan cek kelengkapan data anda akan mengirimkan konfirmasi pada EMAIL anda.</p>
          </center>
          <center>
